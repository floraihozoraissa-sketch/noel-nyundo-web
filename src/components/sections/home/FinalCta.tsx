    ...
    <section className="py-10 md:py-14 bg-neutral-50">
      <Container>
        <div className="relative overflow-hidden rounded-xl bg-primary-900 px-6 py-10 sm:px-10 md:px-14 md:py-14 text-white shadow-card">
          <div className="absolute right-0 top-0 bottom-0 w-16 sm:w-24 lg:w-28 imigongo-side opacity-100 pointer-events-none" />
          <div className="absolute right-0 top-0 bottom-0 w-2 bg-accent-400 pointer-events-none" />
